  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (password === '12345') {
        ...
        setError('Invalid credentials. Hint: Password is 12345');
      }
      setLoading(false);
    }, 800);
  };
          ...
          {activeTab === 'login' ? (
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#60a5fa] focus:border-transparent outline-none transition"
                    required
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#60a5fa] to-[#f9a8d4] text-white py-3 rounded-lg font-medium hover:shadow-lg transition flex justify-center items-center gap-2"
              >
            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f9a8d4] focus:border-transparent outline-none transition"
                    required
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#f9a8d4] to-[#60a5fa] text-white py-3 rounded-lg font-medium hover:shadow-lg transition flex justify-center items-center gap-2"
              >
                {loading && <Loader2 className="w-4 h-4 animate-spin" />}
